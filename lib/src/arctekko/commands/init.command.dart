...
void initCommand(List<String> args) async {
  ...
  await PubspecUtils.addDependencies('velocity_x', '0.4.1');
  await PubspecUtils.addDependencies('http', '0.12.1');
  await PubspecUtils.addDependencies('responsive_framework', '0.0.8');
  await PubspecUtils.addDependencies('font_awesome_flutter', '8.8.1');
  await PubspecUtils.addDependencies('cross_local_storage', '8.8.1');
  await PubspecUtils.addDependencies('flutter_neumorphic', '3.0.1');
